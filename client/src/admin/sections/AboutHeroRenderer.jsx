    ...
    <div className="bg-white">
      ...
      <header className="max-w-7xl mx-auto px-6 pt-16 pb-12 border-b border-stone-50">
        ...
        <input 
          ...
          className="text-4xl md:text-5xl font-black text-stone-900 tracking-tight bg-transparent border-b border-transparent hover:border-stone-200 outline-none w-full"
        />
      </header>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-16">
          <div className="space-y-1">
            ...
            <input 
              ...
              className="text-stone-400 text-[10px] font-black uppercase tracking-[0.2em] bg-transparent border-b border-transparent hover:border-stone-200 outline-none w-full"
            />
          </div>
        ...
        <div className="w-full aspect-[21/9] bg-stone-50 rounded-[2.5rem] overflow-hidden border border-stone-100 relative group">
           <div className="w-full h-full flex items-center justify-center text-stone-200 font-black italic text-xl uppercase tracking-widest">
                <input 
                  className="bg-white/90 border border-stone-200 p-2 text-stone-900 text-xs font-sans not-italic rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" 
                  value={hero_section.main_image} 
                  onChange={(e) => update('hero_section.main_image', e.target.value)}
                />
                <span className="absolute pointer-events-none">[{hero_section.main_image}]</span>
           </div>
        </div>
      </section>
    </div>
